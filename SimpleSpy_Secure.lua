...
local Highlight =
	loadstring(
		game:HttpGet("https://raw.githubusercontent.com/HaydenQL/Chat-bypass/main/Highlight_Local.lua")
	)()
...
function mouseEntered()
	...
	RunService:BindToRenderStep("SIMPLESPY_CURSOR", 1, function()
		if mouseInGui and shared.SimpleSpyExecuted then
...
function shutdown()
	...
	shared.SimpleSpyExecuted = false
end

-- main
if not shared.SimpleSpyExecuted then
	local succeeded, err = pcall(function()
		...
		shared.SimpleSpyShutdown = shutdown
		...
		bringBackOnResize()
		SimpleSpy2.Parent = gethui() or game:GetService("CoreGui")
			CoreGui
		shared.SimpleSpyExecuted = true
