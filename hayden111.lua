...
-- 🌀 Reanimation Tab (Scrollable)
local ReanimationFrame = Instance.new("ScrollingFrame")
ReanimationFrame.Name = "ReanimationFrame"
ReanimationFrame.Size = UDim2.new(1, 0, 1, 0)
ReanimationFrame.CanvasSize = UDim2.new(0, 0, 0, 300)
...
reanLayout.Padding = UDim.new(0, 8)
reanLayout.SortOrder = Enum.SortOrder.LayoutOrder
reanLayout.Parent = ReanimationFrame

local reanPadding = Instance.new("UIPadding")
reanPadding.PaddingTop = UDim.new(0, 10)
