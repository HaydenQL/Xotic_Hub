...
local function animate(isAlreadyLoaded, callback)
    ...
    if isAlreadyLoaded then
        ...
        if keyVerified or game.Players.LocalPlayer.Name == "YournothimbuddyXD" or game.Players.LocalPlayer.Name == "Hayden" or game.Players.LocalPlayer.Name == "xxerray_kingxx" or game.Players.LocalPlayer.Name == "GYATT_DAMN1" or game.Players.LocalPlayer.Name == "BloxiAstra" then
